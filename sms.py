...
def add_student():
    ...
    def submit_student():
        ...
        try:
            ...
            query = '''INSERT INTO student_data (id, name, mobile, email, address, gender, date_of_birth, added_date, added_time)
    ...
    fields = ['ID', 'Name', 'Mobile Number', 'Email', 'Address', 'Gender', 'Date of Birth']
    entries = {}
...
def update_student():
    def update_button():
        try:
            ...
            SET name=%s, mobile=%s, email=%s, address=%s, gender=%s, date_of_birth=%s, added_date=%s, added_time=%s
            WHERE id=%s'''
...
columns = (
    'ID', 'Name', 'Mobile Number', 'Email', 'Address', 'Gender', 'Date of Birth', 'Added Date', 'Added Time'
)
